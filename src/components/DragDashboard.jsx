...
const DragDashboard = () => {
  return (
    <div className='border-2 border-gray-400 rounded-lg m-7 w-auto h-96 flex flex-col items-center justify-center'>
        ...
        <button className='text-sm border-2 border-gray-500 p-2 rounded-lg bg-gray-50 flex gap-2'> <Icon icon="iconoir:add-database-script" width="18" height="18" /> Bulk Upload</button>
        <button className='text-white bg-[#02b9b0] p-2 rounded-lg text-sm flex gap-2 '><Icon icon="iconoir:add-user" width="18" height="18" /> Add Employee</button>
